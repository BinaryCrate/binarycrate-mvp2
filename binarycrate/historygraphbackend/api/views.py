...
class HistoryGraphView(APIView):
    ...
    def get(self, request, documentcollectionid, format=None):
        ...
        history = [(str(edge.documentid),
                ...
                str(edge.propertytype)) for edge in edges]
    ...
    def post(self, request, documentcollectionid, format=None):
        ...
        historyedges2 = [{'documentid': t[0],
                ...
                'propertyname': t[7],
                'propertyvalue': t[8],
                'propertytype': t[9], 'documentcollectionid': documentcollectionid} for t in historyedges if HistoryEdge.objects.by_endnodeid(t[3]).count() == 0]
