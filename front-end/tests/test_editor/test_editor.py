...
"""
        ...
        assert view.context_menu.menu_items[0].context_menu.menu_items[0].text == 'New Button'
        assert callable(view.context_menu.menu_items[0].context_menu.menu_items[0].click_handler)
        ...
        view.last_double_click_item = None
        vnode_button.get_attribs()['onmousedown'](Mock(button=0))
        assert view.selected_item == button['id']
        assert view.mouse_is_down == True
        ...
        assert type(view.context_menu) == ContextMenuFormItems
        assert len(view.context_menu.menu_items) == 3

        assert 'Add onclick Handler' ==  view.context_menu.menu_items[0].text
        assert 'Properties' ==   view.context_menu.menu_items[1].text
        assert 'Delete' ==     view.context_menu.menu_items[2].text
        assert callable(view.context_menu.menu_items[2].click_handler)
        view.mount_redraw.assert_called()
        Router.router.ResetHashChange.assert_called()
        view.context_menu.menu_items[2].click_handler(Mock())
